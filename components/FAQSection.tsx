          ...
          {FAQ_DATA.map((item) => (
            ...
            >
              <CardBody className="p-0">
                <button
                  className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-charcoal-700/30 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-evergreen-300 focus-visible:ring-offset-2 focus-visible:ring-offset-charcoal-800 focus:bg-charcoal-700/30"
