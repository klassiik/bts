      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8 pb-8 border-b border-charcoal-800/50">
          <div itemScope itemType="https://schema.org/LocalBusiness">
            ...
            <p className="text-sm text-charcoal-200 leading-relaxed" itemProp="description">Expert tree care serving Colfax and surrounding areas. Licensed & insured.</p>
          ...
          <nav aria-label="Footer navigation">
            ...
            <ul className="space-y-2.5 text-sm">
              <li className="list-none">
                <Link href="/" className="text-charcoal-200 hover:text-evergreen-400 transition-colors flex items-center gap-2 group" aria-label="Navigate to home page">
                  <span className="w-1.5 h-1.5 bg-sage-600 rounded-full group-hover:bg-evergreen-500 transition-colors" aria-hidden="true"></span>
                  Home
                </Link>
              </li>
              <li className="list-none">
                <Link href="/services" className="text-charcoal-200 hover:text-evergreen-400 transition-colors flex items-center gap-2 group" aria-label="Navigate to services page">
                  <span className="w-1.5 h-1.5 bg-sage-600 rounded-full group-hover:bg-evergreen-500 transition-colors" aria-hidden="true"></span>
                  Services
                </Link>
              </li>
              <li className="list-none">
                <Link href="/service-areas" className="text-charcoal-200 hover:text-evergreen-400 transition-colors flex items-center gap-2 group" aria-label="Navigate to service areas page">
                  <span className="w-1.5 h-1.5 bg-sage-600 rounded-full group-hover:bg-evergreen-500 transition-colors" aria-hidden="true"></span>
                  Service Areas
                </Link>
              </li>
              <li className="list-none">
                <Link href="/about" className="text-charcoal-200 hover:text-evergreen-400 transition-colors flex items-center gap-2 group" aria-label="Navigate to about page">
                  <span className="w-1.5 h-1.5 bg-sage-600 rounded-full group-hover:bg-evergreen-500 transition-colors" aria-hidden="true"></span>
                  About
                </Link>
              </li>
              <li className="list-none">
                <Link href="/contact" className="text-charcoal-200 hover:text-evergreen-400 transition-colors flex items-center gap-2 group" aria-label="Navigate to contact page">
                  <span className="w-1.5 h-1.5 bg-sage-600 rounded-full group-hover:bg-evergreen-500 transition-colors" aria-hidden="true"></span>
                  Contact
                </Link>
              </li>
          ...
          <address className="not-italic" itemScope itemType="https://schema.org/ContactPoint">
            ...
            <div className="space-y-3">
              <a href={`tel:${BUSINESS_INFO.phoneRaw}`} className="flex items-center gap-2 text-sm text-charcoal-200 hover:text-evergreen-400 transition-colors group" aria-label="Call Barker Tree Services" itemProp="telephone">
                <PhoneIcon className="w-5 h-5 text-sage-500 group-hover:text-evergreen-500 transition-colors" aria-hidden="true" />
                {BUSINESS_INFO.phone}
              </a>
              <a href={`mailto:${BUSINESS_INFO.email}`} className="flex items-center gap-2 text-sm text-charcoal-200 hover:text-evergreen-400 transition-colors group" aria-label="Email Barker Tree Services" itemProp="email">
          ...
          <div>
            ...
            <div className="space-y-2.5">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm text-charcoal-200">{BUSINESS_INFO.hours}</p>
                </div>
              </div>
